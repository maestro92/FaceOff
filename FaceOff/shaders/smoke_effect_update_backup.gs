...
#define PARTICLE_FLOAT_LIFE_TIME 1000.0f
...
//            vec3 dir = GetRandomDir(u_time/1000.0);
            ...
            float r = rand(vec2(position0[0].xz));
            vec3 dir = GetRandomDir(r/10.0);

            dir.y = max(dir.y, 0.5);
            velocity1 = normalize(dir) * PARTICLE_EXPLODE_VEL_CONSTANT;
            age1 = 0.0;
            EmitVertex();
            EndPrimitive();
            age = 0.0; 

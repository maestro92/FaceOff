	...
	float zmax, float zmin)
{
	...
	m_type = ModelType::cube_wire_frame;
	...
	// posZ's face
	tmp.m_position = glm::vec3(xmin, ymin, zmax);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmax, ymin, zmax);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmin, ymax, zmax);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmax, ymax, zmax);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	// negZ's face
	tmp.m_position = glm::vec3(xmin, ymin, zmin);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmax, ymin, zmin);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmin, ymax, zmin);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);

	tmp.m_position = glm::vec3(xmax, ymax, zmin);		tmp.m_color = COLOR_RED;
	vertices.push_back(tmp);
